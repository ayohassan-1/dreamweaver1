...
require_once 'db.php'; // Adjusted to ensure it links to the correct db.php within the 'users' folder
...
<head>
    ...
    <link rel="stylesheet" href="style.css"> <!-- Adjusted to the correct path in the 'users' folder -->
    <style>
        .header {
            display: flex;
...
<body>
    ...
    <div class="header">
        <div class="nav-buttons">
            <a href="landing.php">Self-Elevate</a>
        </div>
